...
The data entered into a form needs to be validated to confirm the data entered fits the requierements, and it's done white the user is entering it and before the data is sent to the server.
